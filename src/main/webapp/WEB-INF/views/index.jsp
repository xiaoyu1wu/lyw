...
<head>
    ...
    <link href="/lyw/pcss/project_frontpage.css" rel="stylesheet" type="text/css">
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox" id="pic">
            <div class="item active" id="pic">
                <img src="1474539799836.jpg" alt="kendalljenner">
                <div class="carousel-caption">
                    kendalljenner
                </div>
            </div>
            <div class="item">
                <img id="pic" src="gamersky_03origin_05_201612241730133.jpg" alt="car">
                <div class="carousel-caption">
                    car
                </div>
            </div>
            <div class="item" id="pic">
                <img src="Zed.jpg" alt="zed">
                <div class="carousel-caption">
                    zed
                </div>
            </div>
                ...
                <div class="col-sm-4">
                    <article id=98 class="post">
                        <div class="thumbnail">
                            ...
                            <a href="#"><img src="imgs/s1.jpg" alt="s1" class="zhaopin-pic"></a>
                            <div class="caption">
                                <h3>java工程师</h3>
                                <p>上海进院子软件科技</p>
