            ...
            <div class="row">
                ...
                <div class="col-sm-8 sidebar">
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="inputpassword" class="col-sm-2 control-label">薪资</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <label for="inputpassword" class="col-sm-2 control-label">投递日期</label>
                            <div class="col-sm-8">
                                <input type="datetime" class="form-control" id="birthday" placeholder="投递日期">
                            </div>
                        </div>
